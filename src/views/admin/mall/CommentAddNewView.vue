<template>
    <div>
        ...
        <el-breadcrumb separator-class="el-icon-arrow-right" style="font-size: 16px;">
            ...
            <el-breadcrumb-item :to="{ path: '/admin/mall/comment' }">評論管理</el-breadcrumb-item>
        ...
        <div class="rule-form">
            <el-form :model="ruleForm"  ref="ruleForm" label-width="130px" class="demo-ruleForm">
                ...
                <el-form-item label="評論類型" prop="type">
                    <el-input v-model="ruleForm.type"></el-input>
                    <span>0=好評 1=中評 2=差評</span>
                </el-form-item>
        ...
        methods:{
            ...
            submitForm(formName) {
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        let url = BaseUrl.ADMIN_MALL + '/comments/add-new';
                        console.log('url = ' + url);
